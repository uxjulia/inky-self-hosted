...
export function HelpPage({ isDesktopApp, isSelfHostedBrowser, isHostedApp, standaloneMode, onOpenApp }: HelpPageProps) {
  return (
    <section className="help-page">
      ...
      <div className="help-grid">
        ...
        <article className="help-card">
          ...
          <div>
            ...
            {standaloneMode ? (
              <>
                <p>{isHostedApp ? "Local Library stores EPUBs selected in this browser." : "Local Library stores files selected from this device."}</p>
                <ul>
                  <li>Use the add button in Local Library to pick {isHostedApp ? "EPUB files" : "EPUB, TXT, XTC, XTCH, BMP, or PNG files"}.</li>
      ...
      {(!standaloneMode || isHostedApp) && <section className="help-section">
